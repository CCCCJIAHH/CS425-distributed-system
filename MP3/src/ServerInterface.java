...
public interface ServerInterface extends Remote {
    ...
    /**
     * check if a balance lower than 0
     *
     * @param key
     * @param value
     * @throws RemoteException
     */
    boolean putCheck(String key, Integer value) throws RemoteException;
     ...
     * @throws RemoteException
     */
    void put(String key, Integer value) throws RemoteException;
